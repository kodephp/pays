...
- [微信支付与 kode/miniapp 集成](wechat-integrate-miniapp.md) - openid 注入与多 appid 场景：appid 须与 openid 同源
...
- [个人收款验证器](personal-receive-verifier.md) - 进程内/后台进程抓取收款数据并验证订单匹配
...
- [统一收款码 QrEntry](unified-qr-entry.md) - 聚合收款入口不可变值对象与状态机
