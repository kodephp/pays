...
final class Events
{
     ...
     */
    public const REQUEST_SENDING = 'pay.request.sending';
     ...
     */
    public const REQUEST_SENT = 'pay.request.sent';
     ...
     */
    public const RESPONSE_PARSED = 'pay.response.parsed';
     ...
     */
    public const PAYMENT_SUCCESS = 'pay.payment.success';
     ...
     */
    public const PAYMENT_FAILED = 'pay.payment.failed';
     ...
     */
    public const NOTIFY_RECEIVED = 'pay.notify.received';
     ...
     * payload: array{gateway: string, data: array}
     */
    public const NOTIFY_VERIFIED = 'pay.notify.verified';
     ...
     */
    public const EXCEPTION_OCCURRED = 'pay.exception.occurred';
     ...
     */
    public const REFUND_SUCCESS = 'pay.refund.success';
